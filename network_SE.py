...
from Siamese_SE import SiameseResNet50
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.siamese_resnet50 = SiameseResNet50()
        if torch.cuda.is_available():
            self.siamese_resnet50 = self.siamese_resnet50.cuda()
        #-----------------------------------------
    ...
    def forward(self, input1_tensor, input2_tensor):
        ...
        feature_1_64, feature_1_32, feature_2_64, feature_2_32 = self.siamese_resnet50(input1_tensor, input2_tensor)
